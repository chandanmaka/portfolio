                ...
                <div className={toggleState === 1 ? "qualification__content qualification__content-active" : "qualification__content"}>
                    <div className="qualification__data">
                        <div>
                            ...
                            <span className="qualification__subtitle">Tribhuwan University</span>
                    ...
                    <div className="qualification__data">
                        ...
                        <div>
                            ...
                            <span className="qualification__subtitle">National Examination Board (Nepal)</span>
                            <div className="qualification__calendar">
                    ...
                    <div className="qualification__data">
                        <div>
                            ...
                            <span className="qualification__subtitle">Government of Nepal</span>
                            <div className="qualification__calendar">
                    ...
                    <div className="qualification__data">
                        ...
                        <div>
                            <h3 className="qualification__title">AWS Cloud Foundations Training</h3>
